...
Орбита +: 9,99 USD за месяц. Активная подписка открывает настройки демонстрации экрана до 3840×2160 и 120 FPS, автоматический битрейт до 45 Мбит/с. Доступ проверяется сервером, базовые настройки администратора сохранены отдельно. Цена отображается в профиле телефона и настройках ПК. Фактическая частота зависит от источника изображения, устройства и соединения. Оплата остаётся ручной через администратора.
